            ...
            <form action="" method="post">
              ...
              <p>
                ...
                <select class="input-short" name="patients" id="patients">
                  ...
                  ?>
                    <option value="<?php echo $value['P_ID'];?>"><?php echo $value['PatientName'];?></option>
                  <?php
                  }
                  ?>
                </select>
              ...
              <p>
                ...
                <input type="text" name="aptdate" id="datetimepicker" readonly />
              </p>
              <fieldset>
                <legend>Tasks</legend>
                <ul>
                  <?php foreach($tasks as $key => $value) {?>
                  <li><label><input type="checkbox" name="tasks[]" id="ck_task<?php echo $value['id'];?>" value="<?php echo $value['id']."|".$value['taskname'];?>"/>&nbsp;<?php echo $value['taskname'];?></label></li>
                  <?php } ?>
                </ul>
              </fieldset>
              <fieldset>
                <input class="submit-green" type="submit" name="AddAppointment" value="Submit" /> 
